...
LongUI.Window {
    ...
    ColumnLayout {
        ...
        Image {
            ...
            source: LongUI.Theme.darkMode ? "qrc:/images/dark/world.svg" : "qrc:/images/light/world.svg"
            ...
            Rectangle {
                ...
                visible: false
                border.width: 5
                border.color: Qt.rgba(LongUI.Theme.highlightColor.r,
            ...
            Item {
                ...
                width: popupText.implicitWidth + LongUI.Units.largeSpacing
                height: popupText.implicitHeight + LongUI.Units.largeSpacing
                ...
                Label {
                    ...
                    color: LongUI.Theme.highlightedTextColor
                }
            }
            ...
            MouseArea {
                ...
                onClicked: {
                    ...
                    popupItem.x = mouse.x + LongUI.Units.smallSpacing * 1.5
                    popupItem.y = mouse.y + LongUI.Units.smallSpacing * 1.5
