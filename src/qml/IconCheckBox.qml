...
Item {
    ...
    property var iconSpacing: LongUI.Units.smallSpacing * 0.8
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            color: "transparent"
            border.width: 3
            border.color: control.checked ? LongUI.Theme.highlightColor : "transparent"

            radius: LongUI.Theme.bigRadius + control.iconSpacing
            visible: true
        ...
        Label {
            id: label
            color: control.checked ? LongUI.Theme.highlightColor : LongUI.Theme.textColor
            visible: label.text
