...
RoundedItem {
    ...
    height: mainLayout.implicitHeight + LongUI.Units.largeSpacing * 2
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Item {
                ...
                height: _topLayout.implicitHeight + LongUI.Units.largeSpacing
                ...
                RowLayout {
                    ...
                    Item {
                        width: LongUI.Units.largeSpacing
                    }
                    ...
                    LongUI.RoundImageButton {
                        ...
                        source: LongUI.Theme.darkMode ? additionalSettings.shown ? "qrc:/images/dark/up.svg" : "qrc:/images/dark/down.svg"
        ...
        Hideable {
            ...
            GridLayout {
                Layout.fillWidth: true
                Layout.bottomMargin: LongUI.Units.smallSpacing
            ...
            GridLayout {
                ...
                rowSpacing: LongUI.Units.smallSpacing * 2
            ...
            StandardButton {
                ...
                backgroundColor: LongUI.Theme.darkMode ? "#363636" : LongUI.Theme.backgroundColor
                Layout.fillWidth: true
                visible: !changePasswdLabel.visible
            }
