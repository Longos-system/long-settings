            ...
            RoundedItem {
                RowLayout {
                    ...
                    Label {
                        ...
                        leftPadding: LongUI.Units.smallSpacing
                    }
                ...
                GridView {
                    ...
                    Layout.fillWidth: true
                    implicitHeight: Math.ceil(_view.count / rowCount) * cellHeight + LongUI.Units.largeSpacing
                    ...
                    delegate: Item {
                        ...
                        Rectangle {
                            ...
                            radius: LongUI.Theme.bigRadius + LongUI.Units.smallSpacing / 2
                        ...
                        Image {
                            ...
                            source: LongUI.Theme.darkMode ? "qrc:/images/dark/picture.svg"
...
//            }
    ...
    Component {
        ...
        GridView {
            ...
            implicitHeight: Math.ceil(_colorView.count / _colorView.rowCount) * cellHeight + LongUI.Units.largeSpacing
            ...
            delegate: Rectangle {
                ...
                width: _colorView.itemSize + LongUI.Units.largeSpacing
                height: width
                color: "transparent"
                radius: width / 2
