    ...
    Scrollable {
        ...
        ColumnLayout {
            ...
            RoundedItem {
                ...
                Item {
                    height: LongUI.Units.smallSpacing / 2
                }
                ...
                RowLayout {
                    ...
                    Image {
                        ...
                        source: "qrc:/images/" + (LongUI.Theme.darkMode ? "dark" : "light") + "/display-brightness-low-symbolic.svg"
                    }
                    ...
                    Image {
                        ...
                        sourceSize.height: height
                        Layout.alignment: Qt.AlignVCenter
                        source: "qrc:/images/" + (LongUI.Theme.darkMode ? "dark" : "light") + "/display-brightness-symbolic.svg"
                    }
                }
            ...
            RoundedItem {
                ...
                ListView {
                    ...
                    Layout.preferredHeight: currentItem ? currentItem.layout.implicitHeight + LongUI.Units.largeSpacing : 0
