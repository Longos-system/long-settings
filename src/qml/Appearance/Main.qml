        ...
        ColumnLayout {
            ...
            RoundedItem {
                ...
                GridView {
                    ...
                    property var itemSize: 30 + LongUI.Units.largeSpacing * 2

                    Component.onCompleted: {
                        model.append({"accentColor": String(LongUI.Theme.blueColor)})
                        model.append({"accentColor": String(LongUI.Theme.redColor)})
                        model.append({"accentColor": String(LongUI.Theme.greenColor)})
                        model.append({"accentColor": String(LongUI.Theme.purpleColor)})
                        model.append({"accentColor": String(LongUI.Theme.pinkColor)})
                        model.append({"accentColor": String(LongUI.Theme.orangeColor)})
                        model.append({"accentColor": String(LongUI.Theme.greyColor)})
                    }

                    delegate: Item {
                        id: _accentColorItem

                        property bool checked: Qt.colorEqual(LongUI.Theme.highlightColor, accentColor)
            ...
            RoundedItem {
                ...
                GridLayout {
                    ...
                    columnSpacing: LongUI.Units.largeSpacing * 1.5
                    rowSpacing: LongUI.Units.largeSpacing * 1.5
