...
Item {
    ...
    Rectangle {
        ...
        color: Qt.rgba(LongUI.Theme.highlightColor.r,
                       ...
                       LongUI.Theme.highlightColor.b, 0.4)
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 0.0; color: Qt.rgba(LongUI.Theme.highlightColor.r,
                                                             LongUI.Theme.highlightColor.g,
                                                             LongUI.Theme.highlightColor.b, 1) }
                GradientStop { position: 1.0; color: Qt.rgba(LongUI.Theme.highlightColor.r,
                                                             LongUI.Theme.highlightColor.g,
                                                             LongUI.Theme.highlightColor.b, 0.3) }
            }
