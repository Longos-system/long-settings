...
Canvas {
    ...
    property bool darkMode: LongUI.Theme.darkMode
    property color textColor: LongUI.Theme.textColor
    property color bgColor: LongUI.Theme.secondBackgroundColor
    property color highlightColor: LongUI.Theme.highlightColor
...
//        c.rect(xPadding - 1, yPadding - 1, plotWidth + 2, plotHeight + 2);
        ...
        c.textAlign = "center"
        c.lineWidth = 1
        c.strokeStyle = LongUI.Theme.darkMode ? 'rgba(0, 0, 0, 0.35)' : 'rgba(0, 0, 0, 0.15)'
