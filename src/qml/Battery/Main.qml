    ...
    Scrollable {
        ...
        ColumnLayout {
            ...
            BatteryItem {
                ...
                ColumnLayout {
                    anchors.fill: parent
                    anchors.leftMargin: batteryBackground.radius + LongUI.Units.smallSpacing
            ...
            RoundedItem {
                ...
                RowLayout {
                    ...
                    spacing: LongUI.Units.largeSpacing * 4

                    // Poor
                    Item {
                        height: _poorLabel.implicitHeight + 4 + LongUI.Units.smallSpacing
                        width: _poorLabel.implicitWidth + LongUI.Units.largeSpacing
                    ...
                    Item {
                        height: _normalLabel.implicitHeight + 4 + LongUI.Units.smallSpacing
                        width: _normalLabel.implicitWidth + LongUI.Units.largeSpacing
                    ...
                    Item {
                        height: _excellentLabel.implicitHeight + 4 + LongUI.Units.smallSpacing
                        width: _excellentLabel.implicitWidth + LongUI.Units.largeSpacing
