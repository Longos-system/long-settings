...
Item {
    ...
    height: _itemLayout.implicitHeight + LongUI.Units.largeSpacing
    ...
    ColumnLayout {
        ...
        Item {
            ...
            Layout.preferredHeight: _topItem.implicitHeight + LongUI.Units.largeSpacing
...
//                    }
            ...
            RowLayout {
                ...
                Image {
                    ...
                    source: "qrc:/images/" + (LongUI.Theme.darkMode ? "dark/" : "light/") + model.connectionIcon + ".svg"
                    smooth: false
                }
                ...
                Image {
                    ...
                    height: width
                    sourceSize: Qt.size(width, height)
                    source: LongUI.Theme.darkMode ? "qrc:/images/dark/locked.svg" : "qrc:/images/light/locked.svg"
