...
static const QString s_sServer = "com.long.Settings";
static const QString s_sPath = "/PrimaryBattery";
static const QString s_sInterface = "com.long.PrimaryBattery";
...
Battery::Battery(QObject *parent)
    ...
    , m_interface("com.long.Settings",
                  "/PrimaryBattery",
                  "com.long.PrimaryBattery",
...
{
    QSettings settings(QSettings::UserScope, "longos", "statusbar");
    return settings.value("BatteryPercentage", false).toBool();
}

void Battery::setPercentEnabled(bool value)
{
    QDBusInterface("com.long.Statusbar", "/Statusbar").call("setBatteryPercentage", value);
}
